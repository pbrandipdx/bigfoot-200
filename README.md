...
| `plan/private/` | Local-only, gitignored. Holds the copyrighted runner manual. | not in git |
...
The runner manual is **not** in git at all — it is copyrighted and this repo is public.
It lives locally at `plan/private/runner-manual-2026.md` on the Mac mini.
